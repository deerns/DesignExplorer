      ...
      if (variable) {
        ...
        filter_li
          ...
          .attr("checked", function (d, i) {
            if (selected_colors.indexOf(d) >= 0) return "checked";
            return null;
          })
...
ScatterMatrix.prototype.__draw = function (
  cell_size,
  container_el,
  color_variable,
  selected_colors,
  ...
  this.onData(function () {
    ...
    // Root panel
    var svg = container_el
      .append("svg:svg")
      .attr(
        "width",
        label_height +
          size * x_variables.length +
          axis_width +
          padding +
          legend_width
      )
    ...
    var legend = svg
      ...
      .attr("transform", function (d, i) {
        return (
          "translate(" +
          (label_height + size * x_variables.length + padding) +
          "," +
          (i * 20 + 10) +
          ")"
        );
    ...
    var reshape_axis = function (axis, k) {
      axis.ticks(5).tickFormat(function (d) {
